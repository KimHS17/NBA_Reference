...
<body>
    <div id="board_write">
        ...
        <div id="write_area">
            <form action="ok/ok_yj.php" method="post">
                <div id="in_title">
                    <textarea name="title" id="utitle" rows="1" cols="55" placeholder="제목" maxlength="100" required
                ...
                <div id="in_name">
                    <textarea name="name" id="uname" rows="1" cols="55" placeholder="보낸 이(이메일 형식)" maxlength="100"
                        required style="background: transparent;"></textarea>
                </div>
                <div class="wi_line"></div>
                <div id="in_content">
